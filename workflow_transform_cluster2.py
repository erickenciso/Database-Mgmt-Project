...
with beam.Pipeline('DataflowRunner', options=opts) as p:
    ...
    query_results = p | 'Read from BigQuery' >> beam.io.Read(beam.io.BigQuerySource(query='SELECT user_id, friends FROM workflow.User_Temp'))
    ...
    qualified_table_name = PROJECT_ID + ':workflow.Friend_Count1'
