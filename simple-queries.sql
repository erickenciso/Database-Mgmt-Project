...
--to be useful. The data is ordered by review IDs.
Select * From Yelp_Dataset.Yelp_Review
Where useful > 50
Order by review_id

--From our 'Yelp_User' table, this query displays the names of users, review counts, user's yelp account registration
--dates, and number of fans of users who have more than 100 fans. The data is ordered from the earliest account
--registration date to the latest.
